...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/torchcam-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14878&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/torchcam-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `torchcam` can be installed with:

```
conda install torchcam
```

It is possible to list all of the versions of `torchcam` available on your platform with:
